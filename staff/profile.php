        ...
        if (isset($_FILES['avatar']) && $_FILES['avatar']['error'] !== UPLOAD_ERR_NO_FILE) {
            if ($_FILES['avatar']['error'] !== UPLOAD_ERR_OK) {
                ...
                if (!isset($allowedTypes[$fileType])) {
                    ...
                    $uploadDir = __DIR__ . '/../admin/uploads/avatars';
                    if (!is_dir($uploadDir) && !mkdir($uploadDir, 0755, true)) {
                        ...
                        if (move_uploaded_file($_FILES['avatar']['tmp_name'], $destination)) {
                            $avatarPath = '../admin/uploads/avatars/' . $fileName;
                        } else {
...
<head>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (!sidebarToggle || !staffLayout) return;
        ...
        <div class="profile-grid">
            <section class="profile-card">
                ...
                <div class="profile-details">
                    <h2><?php echo h($fullName ?: 'Staff User'); ?></h2>
                    ...
                    <form method="post" action="profile.php" enctype="multipart/form-data">
                        ...
                        <div class="field-row">
                            ...
                            <div class="field-group">
                                ...
                                <input type="text" id="lastName" name="lastName" value="<?php echo h($user['lastName']); ?>">
                            </div>
                        </div>
                        <div class="field-row">
                            <div class="field-group">
